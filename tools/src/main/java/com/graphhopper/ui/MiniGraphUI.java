        ...
        if (ch) {
            ...
            algoFactory = new RoutingAlgorithmFactory() {
                ...
                class TmpAlgo extends DijkstraBidirectionCH implements DebugAlgo {
                    ...
                    @Override
                    public void updateBestPath(RoutingCHEdgeIteratorState es, SPTEntry entry, int traversalId, boolean reverse) {
                        if (g2 != null)
                ...
                public RoutingAlgorithm createAlgo(Graph g, AlgorithmOptions opts) {
                    ...
                    return new TmpAlgo(new RoutingCHGraphImpl((CHGraph) routingGraph, w), mg);
                }
            };
